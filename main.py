...
try: app_id = int(os.environ.get("app_id", "7024534936"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "AAEW1MQVkbUkujyg2BlOnFF")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7024534936:AAEW1MQVkbUkujyg2BlOnFFt-Ix9pPTc_jM")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{File_name}`@ShikshaGurukul")
...
about_message = """
<b>• Name : <a href=https://t.me/ShikshaGurukul AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/ShikshaGurukul</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/ShikshaGurukul>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/ShikshaGurukul"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/{bot.Quiz_copyright_bot}?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/ShikshaGurukul")
